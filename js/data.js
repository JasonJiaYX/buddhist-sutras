...
const SUTRA_CATALOG = [
  ...
  },
  {
    ...
    category: "道家经典",
    tags: ["道家", "清静", "修心"],
    introduction: "《太上老君说常清静经》，简称《清静经》，是道教的核心经典之一。全书仅四百字左右，阐述了“澄心遣欲”以达到“常清静”的修行境界，对后世内丹学与修真之士影响深远。"
  },
  {
    id: "lunyu",
    title: "论语",
  ...
  },
  {
    ...
    category: "修身经典",
    tags: ["修身", "积善", "因果"],
    introduction: "《文昌帝君阴骘文》，简称《阴骘文》，是传统社会流传极广的劝善书。与《太上感应篇》、《了凡四训》并称为中国传统社会的三大积善修身经典。文内列举诸般善行与戒律，旨在劝导世人广积阴德、利益人天。"
  },
  {
    id: "yijing",
    title: "周易",
    ...
    category: "修身经典",
    tags: ["周易", "哲学", "智慧", "修身"],
    introduction: "《周易》又称《易经》，是中华文化的源头活水，被誉为“群经之首”。它通过六十四卦演变，阐述了天地宇宙万物变化的客观规律，包含着极其深奥的朴素辩证法哲学，并为人生处世、克己修身提供了至高无上的智慧指引。"
  }
];
